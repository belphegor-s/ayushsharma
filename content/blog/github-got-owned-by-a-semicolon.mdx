...
That's a phase change for offensive research. The set of _practically auditable_ software just expanded by an order of magnitude. Every closed-source binary on a defender's network is now slightly less private. I don't have a tidy take on what to do with that. But if your security model has been "the bug isn't worth finding because the source isn't public," that model is over.

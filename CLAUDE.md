...
│                                                         │
│  Title line 1                   (y≈390–430, big title)  │
│  Title line 2                                           │
...
- **Title:** x="120", font-size 88–100, font-weight="700", letter-spacing="-2" or "-3", split into `<tspan>` lines with dy="110"–"118". Start y around 390–430 depending on line count.
...
|--------|--------------|------------|-------------------|
| blue | #0b0f17 → #1e293b | rgba(59,130,246,...) | #93c5fd / #3b82f6 |
| red | #0d0a08 → #2a1410 | rgba(239,68,68,...) | #fca5a5 / #ef4444 |
| green | #060d0a → #111f17 | rgba(34,197,94,...) | #4ade80 / #22c55e |
